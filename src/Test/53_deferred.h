...
private:
	...
	void loadAssets()
	{
		...
		models.floor.loadFromFile(getAssetPath() + "models/deferred_floor.gltf", m_vulkanDevice, queue, glTFLoadingFlags);
		...
		textures.floor.colorMap.loadFromFile(getAssetPath() + "textures/stonefloor01_color_rgba.ktx", VK_FORMAT_R8G8B8A8_UNORM, m_vulkanDevice, queue);
		textures.floor.normalMap.loadFromFile(getAssetPath() + "textures/stonefloor01_normal_rgba.ktx", VK_FORMAT_R8G8B8A8_UNORM, m_vulkanDevice, queue);
	}
