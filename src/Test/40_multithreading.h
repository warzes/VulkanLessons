...
class MultithreadingApp final : public EngineApp
{
public:
...
private:
	...
	void loadAssets()
	{
		...
		models.ufo.loadFromFile(getAssetPath() + "models/retroufo_red_lowpoly.gltf", m_vulkanDevice, queue, glTFLoadingFlags);
		models.starSphere.loadFromFile(getAssetPath() + "models/sphere.gltf", m_vulkanDevice, queue, glTFLoadingFlags);
	}
