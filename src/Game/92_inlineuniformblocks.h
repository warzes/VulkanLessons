...
class InlineUniformBlocksApp final : public EngineApp
{
public:
...
private:
	...
	*/
		...
		for (int32_t i = 0; i < drawCommandBuffers.size(); ++i)
		{
			...
			for (uint32_t x = 0; x < objcount; x++) {
				...
				*/
				...
				vkCmdBindDescriptorSets(drawCommandBuffers[i], VK_PIPELINE_BIND_POINT_GRAPHICS, pipelineLayout, 0, 2, descriptorSets.data(), 0, nullptr);
	...
	void loadAssets()
	{
		model.loadFromFile(getAssetPath() + "models/sphere.gltf", m_vulkanDevice, queue);
