	...
	*/
		...
		*/
		{
			...
			imageCI.extent = { destWidth, destHeight, 1 };
			imageCI.mipLevels = 1;
		...
		*/
		{
			...
			memoryAllocInfo.memoryTypeIndex = m_vulkanDevice->getMemoryType(memReqs.memoryTypeBits, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT);
	...
	void preparePipelines()
	{
		...
		*/
		...
		vkGetPhysicalDeviceFeatures2KHR(m_physicalDevice.physicalDevice, &deviceFeatures2);
