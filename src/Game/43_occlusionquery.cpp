...
//-----------------------------------------------------------------------------
void OcclusionQueryApp::OnKeyPressed(uint32_t key)
{
	if (key == KEY_F2)
	{
...
//-----------------------------------------------------------------------------
void OcclusionQueryApp::OnKeyUp(uint32_t key)
{
	if (camera.type == Camera::firstperson)
	{
		switch (key)
...
//-----------------------------------------------------------------------------
void OcclusionQueryApp::OnMouseMoved(int32_t x, int32_t y, int32_t dx, int32_t dy)
{
