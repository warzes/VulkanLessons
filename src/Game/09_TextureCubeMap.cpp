...
//-----------------------------------------------------------------------------
bool TextureCubeMapApp::OnCreate()
{
...
//-----------------------------------------------------------------------------
void TextureCubeMapApp::OnDestroy()
{
	if (device) {
...
//-----------------------------------------------------------------------------
void TextureCubeMapApp::OnUpdateUIOverlay(vks::UIOverlay* overlay)
{
...
//-----------------------------------------------------------------------------
void TextureCubeMapApp::OnWindowResize(uint32_t destWidth, uint32_t destHeight)
{
	if ((destWidth > 0.0f) && (destHeight > 0.0f))
		camera.updateAspectRatio((float)destWidth / (float)destHeight);
}
//-----------------------------------------------------------------------------
void TextureCubeMapApp::OnKeyPressed(uint32_t key)
{
	if (key == KEY_F2)
	{
...
//-----------------------------------------------------------------------------
void TextureCubeMapApp::OnKeyUp(uint32_t key)
{
	if (camera.type == Camera::firstperson)
	{
		switch (key)
...
//-----------------------------------------------------------------------------
void TextureCubeMapApp::OnMouseMoved(int32_t x, int32_t y, int32_t dx, int32_t dy)
{
...
//-----------------------------------------------------------------------------
void TextureCubeMapApp::loadCubemap(std::string filename, VkFormat format)
{
	ktxResult result;
...
//-----------------------------------------------------------------------------
void TextureCubeMapApp::buildCommandBuffers()
{
...
//-----------------------------------------------------------------------------
void TextureCubeMapApp::setupDescriptors()
{
	// Pool
...
//-----------------------------------------------------------------------------
void TextureCubeMapApp::preparePipelines()
{
	// Layout
...
//-----------------------------------------------------------------------------
void TextureCubeMapApp::updateUniformBuffers()
{
